  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pb-8  flex flex-col">
        ...
        <span className="text-center mt-4">Gen 26 ao 36.</span>

        <div className="text-center">
          <h1 className="text-3xl text-center font-extrabold mt-16">
            #SAVETHE<span className="text-turquoise-400">DATE</span>
          </h1>
          <h2 className="text-8xl text-center text-turquoise-4a00 font-extrabold">
            19/07
          </h2>
          <p className="text-xl font-semibold bg-turquoise-400">
            Sábado ás 19:30
          </p>
        </div>
